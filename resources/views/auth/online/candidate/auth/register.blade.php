...
<body>
    ...
    <div class="container col-md-11">
        ...
        <p class="right">
            <a class="fa fa-sign-out " href="{{ route('dashboard') }}">Dashborad</a>
        </p>
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                <form action="{{ route('online.candidate.store') }}" enctype="multipart/form-data"
                    id="registrationForm" method="post" class="needs-validation" novalidate>
                    @csrf
                    <div class="step">
