    ...
    <div class="container">
        <div class="card-container">
            <div class="card border-primary">
                ...
                <div class="card-body" style="height: 200px; overflow-y: auto;">
                    <ul class="list-group list-group">
                        @foreach ($otherspaymentsindigenes as $otherspaymentsindigene)
                            <li class="list-group-item"><i style="font-weight: 900" class="fa fa-check"></i>
                                {{ $otherspaymentsindigene->name }}
                                (₦{{ number_format($otherspaymentsindigene->price, 2, '.', ',') }})
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="card-footer mt-2 text-center"><a
                        href="{{ route('payment.other.create.indigene') }}"><i
            ...
            <div class="card border-primary">
                ...
                <div class="card-body" style="height: 200px; overflow-y: auto;">
                    <ul class="list-group list-group">
                        @foreach ($otherspaymentsnonindigenes as $otherspaymentsnonindigene)
                            <li class="list-group-item"><i style="font-weight: 900" class="fa fa-check"></i>
                                {{ $otherspaymentsnonindigene->name }}
                                (₦{{ number_format($otherspaymentsnonindigene->price, 2, '.', ',') }})
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="card-footer mt-2 text-center"><a
                        href="{{ route('payment.other.create.nonindigene') }}"><i
                            class="fas fa-arrow-right"></i> Click here to proceed</a></div>
            </div>
