...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 style="font-weight: 700;">UPDATE COURSE BLOG </h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
             <div class="card card-default">
                <div class="card-header">
                 ...
                 <form action="{{ url('update/course/post/'.$post->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>IMAGE</label>
                                    <input type="file" required name="images" class="form-control" style="width: 100%;">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
